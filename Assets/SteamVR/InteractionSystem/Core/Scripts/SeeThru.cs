...
namespace Valve.VR.InteractionSystem
{
    ...
    public class SeeThru : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            interactable.onAttachedToHand.AddListener(AttachedToHand);
            interactable.onDetachedFromHand.AddListener(DetachedFromHand);
        }
        ...
        void OnDisable()
        {
            interactable.onAttachedToHand.RemoveListener(AttachedToHand);
            interactable.onDetachedFromHand.RemoveListener(DetachedFromHand);
        }
