...
namespace UnitySimpleLiquid
{
    ...
    public class LiquidContainer : MonoBehaviour
    {
        ...
        [Tooltip("Smaller inertness - less still 소지하다liquid")]
        ...
        public FluidFlowManager GetFluidFlowManager
        {
            get {return fluidFlowManager; }
            private set { fluidFlowManager = value; }
        }
        ...
        {
            volume = setVolume;
            if(GetFluidFlowManager)
            GetFluidFlowManager.volume = volume;
        }
        ...
        public float FillAmountPercent
        {
            ...
            set
            {
                ...
                { 
                    ...
                    if(GetFluidFlowManager)
                    GetFluidFlowManager.capacity = fillAmountPercent;
                }
                else
                { 
                    fillAmountPercent = 0f;
                    if(GetFluidFlowManager)
                    GetFluidFlowManager.capacity = 0f;
                }
        ...
        private Vector3 CalculateWoldSurfaceLevel()
        {
            ...
            var howLow = 1f - Mathf.Abs(Vector3.Dot(Vector3.up, transform.up));         // 각도 (0~1)
